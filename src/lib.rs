...
use stylus_sdk::{abi::Bytes, alloy_primitives::Address, prelude::*, ArbResult};

#[entrypoint]
#[storage]
struct BeaconProxyWorkshop {
    beacon_proxy: BeaconProxy,
}

#[public]
impl BeaconProxyWorkshop {
    #[constructor]
    pub fn constructor(
        &mut self,
        beacon: Address,
...
unsafe impl IProxy for BeaconProxyWorkshop {
    fn implementation(&self) -> Result<Address, Vec<u8>> {
